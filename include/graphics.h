...
extern const u8 gBerryPic_Pumkin[];
extern const u8 gBerryPic_Drash[];
extern const u8 gBerryPic_Eggant[];
extern const u8 gBerryPic_Strib[];
extern const u8 gBerryPic_Chilan[];
extern const u8 gBerryPic_Nutpea[];
extern const u8 gBerryPic_Ginema[];
extern const u8 gBerryPic_Kuo[];
extern const u8 gBerryPic_Yago[];
extern const u8 gBerryPic_Touga[];
extern const u8 gBerryPic_Niniku[];
extern const u8 gBerryPic_Topo[];
...
extern const u8 gBerryPalette_Pumkin[];
extern const u8 gBerryPalette_Drash[];
extern const u8 gBerryPalette_Eggant[];
extern const u8 gBerryPalette_Strib[];
extern const u8 gBerryPalette_Chilan[];
extern const u8 gBerryPalette_Nutpea[];
extern const u8 gBerryPalette_Ginema[];
extern const u8 gBerryPalette_Kuo[];
extern const u8 gBerryPalette_Yago[];
extern const u8 gBerryPalette_Touga[];
extern const u8 gBerryPalette_Niniku[];
extern const u8 gBerryPalette_Topo[];
