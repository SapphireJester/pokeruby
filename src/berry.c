...
static const u8 sBerryDescriptionPart1_Ginema[] = _("Peel off the thin skin and the BERRY");
static const u8 sBerryDescriptionPart2_Ginema[] = _("becomes round. It is very dry and sour.");
static const u8 sBerryDescriptionPart1_Kuo[] = _("All five flavors mix deliciously. It");
...
static const u8 sBerryDescriptionPart2_Topo[] = _("It is full of sweet and sour juices.");
